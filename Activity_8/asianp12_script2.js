...
function averagePerProduct(productName){
    ...
    console.log('Average price of Ceiling Fan: $' + ceilingfan.toFixed(2));
    console.log('Average price of Wall Light: $' + wallLight.toFixed(2));
    console.log('Average price of Jacket: $' + jacket.toFixed(2));
