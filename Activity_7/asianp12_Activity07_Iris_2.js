...
function split_and_matrix(matrix){
    let iris_lines = iris.split("\n");
    for(let i = 1; i < iris_lines.length; i++){
        let iris_line = iris_lines[i];
        let iris_elements = iris_line.split(",");
        matrix.push(iris_elements);
    }
}
...
["Iris-versicolor",versicolor_count,versicolor_sepal_Length,versicolor_sepal_Width,versicolor_petal_Length,versicolor_petal_Width],["Iris-virginica",virginica_count,virginica_sepal_Length,virginica_sepal_Width,virginica_petal_Length,virginica_petal_Width]];
console.log("IRIS STATISTICS :");
console.table(iristable);
console.log("Anthony Phan");
console.log("Asianp12@iastate.edu");
console.log("September 16, 2024");